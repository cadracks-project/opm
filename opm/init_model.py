...
db['country_description'].insert({'country': fra_id, 'language': es_id, 'country_sdesc': "Francia", 'country_ldesc': 'Republica Francase'})
...
db['unit_description'].insert({'unit': mm_id, 'language': en_id, 'unit_sdesc': 'Millimeter', 'unit_ldesc': 'Millimeter'})
db['unit_description'].insert({'unit': mm_id, 'language': fr_id, 'unit_sdesc': 'Millimètre', 'unit_ldesc': 'Millimètre'})
db['unit_description'].insert({'unit': mm_id, 'language': es_id, 'unit_sdesc': 'Millimetro', 'unit_ldesc': 'Millimetro'})
db['unit_description'].insert({'unit': cm_id, 'language': en_id, 'unit_sdesc': 'Centimeter', 'unit_ldesc': 'Centimeter'})
db['unit_description'].insert({'unit': cm_id, 'language': fr_id, 'unit_sdesc': 'Centimètre', 'unit_ldesc': 'Centimètre'})
db['unit_description'].insert({'unit': cm_id, 'language': es_id, 'unit_sdesc': 'Centimetro', 'unit_ldesc': 'Centimetro'})
db['unit_description'].insert({'unit': m_id, 'language': en_id, 'unit_sdesc': 'Meter', 'unit_ldesc': 'Meter'})
db['unit_description'].insert({'unit': m_id, 'language': fr_id, 'unit_sdesc': 'Mètre', 'unit_ldesc': 'Mètre'})
db['unit_description'].insert({'unit': m_id, 'language': es_id, 'unit_sdesc': 'Metro', 'unit_ldesc': 'Metro'})
